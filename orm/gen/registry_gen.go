	...
	Entities: map[string]runtime.EntitySpec{
		...
		"User": {
			...
			Fields: []runtime.FieldSpec{
				...
				{Name: "password", Column: "password_hash", GoType: "string", Type: dsl.TypeText, Primary: false, Nullable: false, Unique: false, DefaultNow: false, UpdateNow: false, DefaultExpr: "", ReadOnly: false, ComputedSpec: nil, Annotations: map[string]any{"notEmpty": true}, EnumValues: nil, EnumName: ""},
